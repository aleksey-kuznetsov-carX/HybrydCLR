...
IL_0017:
	{
		...
		*((RuntimeObject**)L_4) = (RuntimeObject*)L_5;
		...
		NullCheck(L_10);
		String_t* L_11;
		L_11 = VirtualFuncInvoker0< String_t* >::Invoke(31, L_10);
...
IL_0048_1:
			{
				...
				NullCheck(L_16);
				bool L_19;
				L_19 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(27, L_16, L_18);
				V_7 = L_19;
				bool L_20 = V_7;
				if (!L_20)
				{
...
IL_00bb_1:
			{
				...
				NullCheck(L_41);
				bool L_44;
				L_44 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(27, L_41, L_43);
				V_12 = L_44;
				bool L_45 = V_12;
				if (!L_45)
				{
...
IL_00ff_1:
		{
			...
			NullCheck(L_48);
			FieldInfo_t* L_50;
			L_50 = VirtualFuncInvoker2< FieldInfo_t*, String_t*, int32_t >::Invoke(112, L_48, L_49, ((int32_t)88));
			V_14 = L_50;
