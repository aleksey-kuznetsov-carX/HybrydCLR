...
public class LoadingAssetsService : MonoBehaviour {
    ...
    public async UniTask Load() {
        ...
        IResourceLocator resourceLocator = await Addressables.LoadContentCatalogAsync($"https://carx-str.s3.us-east-1.amazonaws.com/assetbundles/test/dev-kuznetsov/develop/HybridCLRCatalogs/Android/catalog_{Application.version}.json");
    ...
    private async UniTask CheckForCatalogUpdate() {
        ...
        await Addressables.LoadContentCatalogAsync($"https://carx-str.s3.us-east-1.amazonaws.com/assetbundles/test/dev-kuznetsov/develop/HybridCLRCatalogs/Android/catalog_{Application.version}.json");
    }
